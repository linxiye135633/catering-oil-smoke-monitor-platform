package org.jeecg.modules.psms.supervision.service;
...
public interface SupervisionService extends IService<Map<String,Object>> {
    /**
     ...
     */
    int getRiskVCount(String format, int i, String valueOf);

    /**
     * 根据日期 查询出警告企业列表内容
     */
    Page<Map<String, Object>> getNewRisk(Page<Map<String, Object>>page,int fidRegion, String format);
     ...
     * 根据日期查询出 接触风险企业
     */
    Page<Map<String, Object>> getClearRiskList(Page<Map<String, Object>> page, int fidRegion, String format);
