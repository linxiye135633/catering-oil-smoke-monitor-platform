...
public class JeecgRedisCacheWriter implements RedisCacheWriter {
    ...
    /**
     * Spring Data Redis 2.4+ 新增接口方法：按传入的统计收集器派生新 Writer。
     */
    @Override
    public RedisCacheWriter withStatisticsCollector(CacheStatisticsCollector cacheStatisticsCollector) {
        return new JeecgRedisCacheWriter(this.connectionFactory, this.sleepTime, cacheStatisticsCollector);
    }

    @Override
    public void clearStatistics(String name) {
        this.statisticsCollector.reset(name);
    }

    @Override
    public org.springframework.data.redis.cache.CacheStatistics getCacheStatistics(String cacheName) {
        return this.statisticsCollector.getCacheStatistics(cacheName);
    }
