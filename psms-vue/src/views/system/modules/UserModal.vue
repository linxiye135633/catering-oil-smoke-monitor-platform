  ...
  >
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="账号编码" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="fidRegion">
          <a-input placeholder="请输入账号编码（由平台方提供）" v-model="model.fidRegion" />
        </a-form-model-item>
        <a-form-model-item label="服务厂商编号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="manufacturerCcode">
          <a-input placeholder="服务厂商编号（由平台方提供）" v-model="model.manufacturerCode" />
        </a-form-model-item>
      </a-form-model>
    </a-spin>
  ...
  data() {
    return {
      ...
      validatorRules: {
        ...
        fidRegion: [{ required: true, message: '请输入用户编码!' }],
        manufacturerCode: [{ required: true, message: '请输入服务厂商号!' }]
      },
      departIdShow: false,
      title: '操作',
      visible: false,
