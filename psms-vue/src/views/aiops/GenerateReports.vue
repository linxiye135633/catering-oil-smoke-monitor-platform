    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <a-col :xl="4" :lg="7" :md="8" :sm="24">
            <a-form-item>
              <a-select v-model="queryParam.comStatus" placeholder="请选择运维报告状态">
                <a-select-option value="1"> 尚未生成报告 </a-select-option>
                <a-select-option value="2"> 已生成待发布 </a-select-option>
                <a-select-option value="3"> 已生成已发布 </a-select-option>
              </a-select>
            </a-form-item>
          </a-col>
